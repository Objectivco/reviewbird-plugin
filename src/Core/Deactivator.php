...
class Deactivator {
	...
	public static function deactivate() {
		...
		wp_clear_scheduled_hook( 'reviewbird_sync_products' );
		wp_clear_scheduled_hook( 'reviewbird_sync_reviews' );
		wp_clear_scheduled_hook( 'reviewbird_cleanup_oauth_states' );
