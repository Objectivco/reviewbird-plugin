...
class Settings {
	...
	public function display_oauth_notices(): void {
		...
		if ( ! $screen || 'toplevel_page_reviewbird-settings' !== $screen->id ) {
			return;
		}
	...
	public function enqueue_scripts( string $hook ): void {
		if ( 'toplevel_page_reviewbird-settings' !== $hook ) {
			return;
		}
	...
	private function get_script_localization_data(): array {
		return array(
			...
			'appHomeUrl'       => reviewbird_get_api_url(),
			'marketingUrl'     => 'https://reviewbird.com',
