...
class CouponController {
    ...
    public function register_routes() {
        register_rest_route('reviewapp/v1', '/coupons/create', [
            'methods' => 'POST',
    ...
    public function check_store_token(WP_REST_Request $request) {
        ...
        $saved_token = get_option('reviewapp_store_token');
    ...
    private function clone_template_coupon($template_code, $new_code, $expiry_date) {
        ...
        // Add metadata to track this is from ReviewApp
        $coupon->add_meta_data('_reviewapp_generated', true);
        $coupon->add_meta_data('_reviewapp_template', $template_code);
